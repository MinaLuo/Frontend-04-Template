...
function layout(element) {
    ...
    if (mainSpace < 0) {
        // overflow (happens only if container is single line),scale every itme
        ...
        for (var i = 0; i < items.length; i++) {
            ...
            itemStyle[mianEnd] = itemStyle[mainStart] + mainSign * itemStyle[mainSize];
    ...
    if (style.alignContent === 'space-between') {
        crossBase += 0;
        atep = crossSpace / (flexLines.length - 1);
    }
